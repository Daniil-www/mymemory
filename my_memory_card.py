...
questions_list = []
questions_list.append(Question('Госурственный язык Бразилии', 'Португальский', 'Английский', 'Испанский', 'Бразильский'))
...
def check_answer():
    if answers[0].isChecked():
        ...
        if answer[1].isChecked() or answers[2].isChecked() or answers[3].isChecked():
